...
function ProductDescription() {
  ...
  // function handleAddCart(e: React.MouseEvent<HTMLDivElement, MouseEvent>){
  ...
  return (
    <div className="flex flex-col gap-3 p-6 lg:max-w-[445px] lg:gap-7">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:mt-2">
        ...
        <button className="bg-primary-orange hover:bg-[#DB5F13] shadow-[0px_20px_50px_-20px_rgba(255,126,27,1.0)] flex items-center py-3 w-full rounded-xl justify-center gap-2 lg:w-[272px]">
